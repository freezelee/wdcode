...
<head>
   ...
   <style type="text/css">
		body{
			background-color: #DBEEFD;font-family: "微软雅黑","Arial";
		}
		table{
			padding-left: 30px;
		}
		...
		.boxB1{
			...
			border-top-left-radius: 5px;border-top-right-radius: 5px;border: 1px solid #3C9ADA;margin-top: 10px;
			padding: 5px 3px 5px 20px;font-size: 14px;color: white;box-shadow: 1px 0px 0px #9FC4FF;
		}
		.boxB2{
			height: 450px;border: 1px solid #88B4FD;border-top-color: white;background-color: #FAFAFA;
...
<@s.iterator var="temHidden" value="#attr.template.get('hidden')">
	...
	<div class="boxA">
		...
		<div class="boxB2">
			<div class="B_title">${action.getText('title')}</div>
			<div class="B_line">
