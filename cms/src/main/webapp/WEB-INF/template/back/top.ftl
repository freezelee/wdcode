...
<div id="top">
     <div class="top">
          ...
          <tr>
            <td width="215"><div class="logo"><img src="${base}/res/jeecms/img/admin/logo.png" width="215" height="69" /></div></td>
            <td valign="top">
                <div class="topbg">
                     ...
                     <div class="nav">
                     	  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                ...
                                <td>
                                	<ul class="nav-menu">
                                    	<li class="current" id="tb_11" onclick="HoverLi(1,1,10);"><a href="main.do" target="mainFrame"><@s.m "global.admin.home"/></a></li>
										<@cms_perm url="/frame/channel_main.do">			
										<li class="sep"></li><li class="normal" id="tb_12" onclick="HoverLi(1,2,10);"><a href="frame/channel_main.do" target="mainFrame"><@s.m "cms.function.channel"/></a></li>
										</@cms_perm>
										<@cms_perm url="/frame/content_main.do">
										<li class="sep"></li><li class="normal" id="tb_13" onclick="HoverLi(1,3,10);"><a href="frame/content_main.do" target="mainFrame"><@s.m "cms.function.content"/></a></li>
										</@cms_perm>
										<@cms_perm url="/frame/template_main.do">
										<li class="sep"></li><li class="normal" id="tb_14" onclick="HoverLi(1,4,10);"><a href="frame/template_main.do" target="mainFrame"><@s.m "cms.function.template"/></a></li>
										</@cms_perm>
										<@cms_perm url="/frame/resource_main.do">
										<li class="sep"></li><li class="normal" id="tb_15" onclick="HoverLi(1,5,10);"><a href="frame/resource_main.do" target="mainFrame"><@s.m "cms.function.resource"/></a></li>
										</@cms_perm>
										<@cms_perm url="/frame/assistant_main.do">
										<li class="sep"></li><li class="normal" id="tb_16" onclick="HoverLi(1,6,10);"><a href="frame/assistant_main.do" target="mainFrame"><@s.m "cms.function.assistant"/></a></li>
										</@cms_perm>
										<@cms_perm url="/frame/maintain_main.do">
										<li class="sep"></li><li class="normal" id="tb_17" onclick="HoverLi(1,7,10);"><a href="frame/maintain_main.do" target="mainFrame"><@s.m "cms.function.maintain"/></a></li>
										</@cms_perm>
										<@cms_perm url="/frame/generate_main.do">
										<li class="sep"></li><li class="normal" id="tb_18" onclick="HoverLi(1,8,10);"><a href="frame/generate_main.do" target="mainFrame"><@s.m "cms.function.generate"/></a></li>
										</@cms_perm>
										<@cms_perm url="/frame/user_main.do">
										<li class="sep"></li><li class="normal" id="tb_19" onclick="HoverLi(1,9,10);"><a href="frame/user_main.do" target="mainFrame"><@s.m "cms.function.user"/></a></li>
										</@cms_perm>
										<@cms_perm url="/frame/config_main.do">
										<li class="sep"></li><li class="normal" id="tb_110" onclick="HoverLi(1,10,10);"><a href="frame/config_main.do" target="mainFrame"><@s.m "cms.function.config"/></a></li>
										</@cms_perm>
										<!-- 
