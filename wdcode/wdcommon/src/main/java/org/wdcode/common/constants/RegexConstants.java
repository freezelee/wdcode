...
public final class RegexConstants {
	 ...
	 * Date 如2004-06-06
	 */
	public final static String	DATE			= "^(\\d{4})\\-(0[1-9]|1[0-2])\\-(0[1-9]|1[0-9]|2[0-9]|3[0-1])$";
	/**
	 * DateTime 如2004-11-12 12:10:16
	 */
	public final static String	DATETIME		= "^(\\d{4})\\-(0[1-9]|1[0-2])\\-(0[1-9]|1[0-9]|2[0-9]|3[0-1]) (0[0-9]|1[0-9]|2[0-4]):([0-5][0-9]):([0-5][0-9])$";
	/**
	 * 汉字
	 */
