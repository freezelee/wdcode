		...
		zoomimage: {
				...
				'<div class="zoomimage">',
					'<div class="zoomimage_s">',
						'<div class="zoomimage_st">',
							'<div class="zoomimage_stl belatedPNG"></div>',
							'<div class="zoomimage_stc belatedPNG"></div>',
							'<div class="zoomimage_str belatedPNG"></div>',
						'</div>',
						'<div class="zoomimage_sc">',
							'<div class="zoomimage_scl belatedPNG"></div>',
							'<div class="zoomimage_scc belatedPNG"></div>',
							'<div class="zoomimage_scr belatedPNG"></div>',
						'</div>',
						'<div class="zoomimage_sb">',
							'<div class="zoomimage_sbl belatedPNG"></div>',
							'<div class="zoomimage_sbc belatedPNG"></div>',
							'<div class="zoomimage_sbr belatedPNG"></div>',
						'</div>',
					'</div>',
					'<img src="" />',
					'<div class="zoomimage_controls">',
						'<a href="#" class="zoomimage_prev belatedPNG"></a>',
						'<a href="#" class="zoomimage_next belatedPNG"></a>',
					'</div>',
			...
			keyPressed: function(e) {
				...
				if (el.size() == 1) {
					...
					}else if(pressedKey==40 || pressedKey==37 ||pressedKey==8||pressedKey==33||pressedKey==80||pressedKey==112){
						// go to the previous image in the gallery
						if (EYE.zoomimage.libs[lib] > 1) {
							EYE.zoomimage.zoomNext(el, -1);
							return false;
						}
					} else if(pressedKey==38 || pressedKey==39 ||pressedKey==34||pressedKey==32||pressedKey==110||pressedKey==78){
